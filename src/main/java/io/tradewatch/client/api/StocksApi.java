...
public class StocksApi {
    ...
    public okhttp3.Call getCountriesCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/stocks/countries";
     ...
     */
    public CountriesList getCountries() throws ApiException {
        ApiResponse<CountriesList> localVarResp = getCountriesWithHttpInfo();
     ...
     */
    public ApiResponse<CountriesList> getCountriesWithHttpInfo() throws ApiException {
    ...
    /**
     * Available Countries (asynchronously)
     * Get list of available countries
     ...
     */
    public okhttp3.Call getCountriesAsync(final ApiCallback<CountriesList> _callback) throws ApiException {
    ...
    public okhttp3.Call getQuoteCall(String symbol, Integer precision, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/stocks/symbols/{symbol}"
     ...
     */
    public okhttp3.Call getSymbolsCall(SymbolsListMode mode, Integer size, Country country, Integer page, String cursor, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/stocks/symbols";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSymbolsValidateBeforeCall(SymbolsListMode mode, Integer size, Country country, Integer page, String cursor, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'mode' is set
        if (mode == null) {
            throw new ApiException("Missing the required parameter 'mode' when calling getSymbols(Async)");
        }

        return getSymbolsCall(mode, size, country, page, cursor, _callback);
     ...
     */
    public CursorPageTCustomizedSymbolsOutFull getSymbols(SymbolsListMode mode, Integer size, Country country, Integer page, String cursor) throws ApiException {
        ApiResponse<CursorPageTCustomizedSymbolsOutFull> localVarResp = getSymbolsWithHttpInfo(mode, size, country, page, cursor);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CursorPageTCustomizedSymbolsOutFull> getSymbolsWithHttpInfo(SymbolsListMode mode, Integer size, Country country, Integer page, String cursor) throws ApiException {
        okhttp3.Call localVarCall = getSymbolsValidateBeforeCall(mode, size, country, page, cursor, null);
     ...
     */
    public okhttp3.Call getSymbolsAsync(SymbolsListMode mode, Integer size, Country country, Integer page, String cursor, final ApiCallback<CursorPageTCustomizedSymbolsOutFull> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSymbolsValidateBeforeCall(mode, size, country, page, cursor, _callback);
        Type localVarReturnType = new TypeToken<CursorPageTCustomizedSymbolsOutFull>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
