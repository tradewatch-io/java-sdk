...
public class CryptoConversionQuery {
  ...
  public CryptoConversionQuery from(String from) {
    this.from = from;
    return this;
  }
  ...
  public CryptoConversionQuery to(String to) {
    this.to = to;
    return this;
  }
  ...
  public CryptoConversionQuery amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public CryptoConversionQuery precision(Integer precision) {
