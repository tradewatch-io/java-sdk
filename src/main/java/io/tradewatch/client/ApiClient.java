...
import io.tradewatch.client.auth.Authentication;
import io.tradewatch.client.auth.HttpBasicAuth;
import io.tradewatch.client.auth.HttpBearerAuth;
import io.tradewatch.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.tradewatch.io";
    ...
    public ApiClient() {
        ...
        authentications.put("api_key_header", new ApiKeyAuth("header", "api-key"));
        authentications.put("api_key_query", new ApiKeyAuth("query", "api-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.tradewatch.io
     ...
     * @return a {@link io.tradewatch.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws io.tradewatch.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.tradewatch.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.tradewatch.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.tradewatch.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.tradewatch.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.tradewatch.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.tradewatch.client.ApiException If fails to update the parameters
     */
     ...
     * @throws io.tradewatch.client.ApiException If fail to serialize the request body object into a string
     */
