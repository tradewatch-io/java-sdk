...
public class TradewatchApiClientBuilder {
   ...
   * Sets apiKey
   */
  public TradewatchApiClientBuilder apiKey(String apiKey) {
    this.apiKey = apiKey;
    return this;
  }

  public TradewatchApiClientBuilder environment(Environment environment) {
    this.environment = environment;
    return this;
  }

  public TradewatchApiClientBuilder url(String url) {
   ...
   */
  public TradewatchApiClientBuilder timeout(int timeout) {
   ...
   */
  public TradewatchApiClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public TradewatchApiClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public TradewatchApiClientBuilder addHeader(String name, String value) {
  ...
  public TradewatchApiClient build() {
    if (apiKey == null) {
      throw new RuntimeException("Please provide apiKey");
    }
    validateConfiguration();
    return new TradewatchApiClient(buildClientOptions());
  }
}
