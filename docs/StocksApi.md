...
import io.tradewatch.client.api.StocksApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling StocksApi#getCountries");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling StocksApi#getQuote");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getSymbols"></a>
# **getSymbols**
> CursorPageTCustomizedSymbolsOutFull getSymbols(mode, size, country, page, cursor)
...
public class Example {
  public static void main(String[] args) {
    ...
    Country country = Country.fromValue("fr"); // Country | 
    ...
    try {
      ...
      System.err.println("Exception when calling StocksApi#getSymbols");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **country** | [**Country**](.md)|  | [optional] [enum: fr, us, de, nz, nl, uk, es, cn, ch, gr, be, pt, it, all] |
